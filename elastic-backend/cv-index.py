...
# add a check to see if the index already exists
if es.indices.exists(index=INDEX):
    print(f"index '{INDEX}' already exists, skipping ingestion.")
else:
    print(f"index '{INDEX}' does not exist, creating index and ingesting data")
